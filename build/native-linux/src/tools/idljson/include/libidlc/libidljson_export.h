...
#      define LIBIDLJSON_EXPORT __attribute__((visibility("default")))
#    else
...
#    define LIBIDLJSON_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef LIBIDLJSON_DEPRECATED
#  define LIBIDLJSON_DEPRECATED __attribute__ ((__deprecated__))
#endif
