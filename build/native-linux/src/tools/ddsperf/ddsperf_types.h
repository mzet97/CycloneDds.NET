/****************************************************************
  ...
  File name: /mnt/e/TI/git/tese/CycloneDds.NET/build/native-linux/src/tools/ddsperf/ddsperf_types.h
  Source: /mnt/e/TI/git/tese/cyclonedds/src/tools/ddsperf/ddsperf_types.idl
  Cyclone DDS: V0.11.0

*****************************************************************/
#ifndef DDSC__MNT_E_TI_GIT_TESE_CYCLONEDDS_NET_BUILD_NATIVE_LINUX_SRC_TOOLS_DDSPERF_DDSPERF_TYPES_H_8559D85AB7166A6C9795DF5DD87A56BF
#define DDSC__MNT_E_TI_GIT_TESE_CYCLONEDDS_NET_BUILD_NATIVE_LINUX_SRC_TOOLS_DDSPERF_DDSPERF_TYPES_H_8559D85AB7166A6C9795DF5DD87A56BF
...
typedef struct Unkeyed1k
{
  uint32_t seq;
  uint8_t baggage[1020];
} Unkeyed1k;

extern const dds_topic_descriptor_t Unkeyed1k_desc;

#define Unkeyed1k__alloc() \
((Unkeyed1k*) dds_alloc (sizeof (Unkeyed1k)));

#define Unkeyed1k_free(d,o) \
dds_sample_free ((d), &Unkeyed1k_desc, (o))

typedef struct Unkeyed64k
{
  uint32_t seq;
  uint8_t baggage[65532];
} Unkeyed64k;

extern const dds_topic_descriptor_t Unkeyed64k_desc;

#define Unkeyed64k__alloc() \
((Unkeyed64k*) dds_alloc (sizeof (Unkeyed64k)));

#define Unkeyed64k_free(d,o) \
dds_sample_free ((d), &Unkeyed64k_desc, (o))
...
#endif /* DDSC__MNT_E_TI_GIT_TESE_CYCLONEDDS_NET_BUILD_NATIVE_LINUX_SRC_TOOLS_DDSPERF_DDSPERF_TYPES_H_8559D85AB7166A6C9795DF5DD87A56BF */
